...
class DetailViewController: UIViewController {
    ...
    func setupImage() {
        ...
        eventImage.layer.borderWidth = 1.5
        view.addSubview(eventImage)
    }
    
    func setupLabels() {
        eventName = UILabel(frame: rRect(rx: 0, ry: 71, rw: 375, rh: 48))
        ...
        eventInterested = UILabel(frame: rRect(rx: 220, ry: 334, rw: 110, rh: 24))
        ...
        eventPoster = UILabel(frame: rRect(rx: 21, ry: 369, rw: 300, rh: 27))
        ...
        eventDescription = UILabel(frame: rRect(rx: 21, ry: 402, rw: 300, rh: 52))
        ...
        eventDate = UILabel(frame: rRect(rx: 160, ry: 533, rw: 210, rh: 27))
    ...
    func setupButtons() {
        interestedButton = UIButton(frame: rRect(rx: 54, ry: 573, rw: 267, rh: 70))
